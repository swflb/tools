...
### spotify client
cd ${install_dir}
wget http://repository-origin.spotify.com/pool/non-free/s/spotify-client/spotify-client_1.0.36.120.g536a862f-20_amd64.deb
sudo dpkg -i spotify-client_1.0.36.120.g536a862f-20_amd64.deb
